...
<ul>
    <li>
        <p>Select <img src="open_doc.png" width="18" height="18"> to edit a different HTML document, like <a href="demo.html">demo.html</a>, that has more detail about the MarkupEditor.</p>
    </li>
    <li>
        <p>Select <img src="new_doc.png" width="18" height="18"> to edit a new HTML document.</p>
    </li>
</ul>
