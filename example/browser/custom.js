...
<p>Start editing this document or...</p>
<ul>
    <li>
        <p>Select <img src="resources/open_doc.png" width="18" height="18"> to edit a different HTML document, like <a href="demo.html">demo.html</a>, that has more detail about the MarkupEditor.</p>
    </li>
    <li>
        <p>Select <img src="resources/new_doc.png" width="18" height="18"> to edit a new HTML document.</p>
    </li>
</ul>
<p>You can view the underlying HTML and see it change as you edit by selecting the HTML button.</p>
<h4>Enjoy!</h4>
`
